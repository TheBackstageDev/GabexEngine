...
namespace GWIN
{
    ...
    GPipeLine::~GPipeLine()
    {
        vkDestroyShaderModule(gDevice.device(), vertShaderModule, nullptr);
        vkDestroyShaderModule(gDevice.device(), fragShaderModule, nullptr);
        vkDestroyPipeline(gDevice.device(), graphicsPipeline, nullptr);
    }

    std::vector<char> GPipeLine::readFile(const std::string &filepath)
    {
    ...
    void GPipeLine::createGraphicsPipeline(
        const std::string &vertFilepath,
        const std::string &fragFilepath,
        const PipelineConfigInfo &configInfo)
    {
...
/*         pipelineInfo.renderPass = configInfo.renderPass;
    ...
    void GPipeLine::defaultPipelineConfigInfo(PipelineConfigInfo &configInfo)
    {
    ...
    void GPipeLine::enableAlphaBlending(PipelineConfigInfo &configInfo)
    {
        configInfo.colorBlendAttachment.colorWriteMask =
            VK_COLOR_COMPONENT_R_BIT | VK_COLOR_COMPONENT_G_BIT | VK_COLOR_COMPONENT_B_BIT |
            VK_COLOR_COMPONENT_A_BIT;
